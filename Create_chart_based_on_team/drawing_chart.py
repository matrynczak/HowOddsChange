...
def horizontal_chart(home_odd, draw_odd, away_odd, home_name, away_name, home_goals, away_goals):
...
#    fig = plt.figure()
 ...
 #   ax = fig.add_subplot(-180)
    ...
    # ylabel('Wynik')
    title('Najbardziej prawdopobny wynik: ' + str(home_goals) + ' : ' + str(away_goals))
    #grid(True)
